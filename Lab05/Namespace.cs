...
namespace Order{
    class Grocery_items{
        public void Ord_grocery(){
            ...
            objCust1.getName();
            Console.WriteLine("Hello {0}", objCust1.srtName);
            Console.WriteLine("You hava ordered grocery items");
        }
    }
    class Bakery_items{
        public void Ord_bakery(){
            ...
            objCust2.getName();
            Console.WriteLine("Hello {0}", objCust2.srtName);
            Console.WriteLine("You hava ordered bakery items");
        }
    }
}
class OrderTest{
